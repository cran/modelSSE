...
#' The function \code{d_reproductiondistn()} was used mainly for data visualization purpose (rather than using for analysis),
...
#'   \item{\code{r_offspringdistn()}}{ is the *random variable generating function*, and it generates a set of \code{n} random variables (non-negative integers). }
#' }
#'
#' @import Delaporte
#'
